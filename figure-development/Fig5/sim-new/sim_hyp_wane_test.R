...
out.cam.wane.test = sim.SIR.age.four.clim.wane(yrs=10,
                                              ntyr=26,
                                              s=101, 
...
save(out.cam.wane.test, file = "cam-sim-4-sero-wane-test.Rdata")

load("cam-sim-4-sero-wane-test.Rdata")
...
out.age.wane <- summarise.age.dist(dat = out.cam.wane.test, year.start = 2011)
...
plot.age.dist(df=out.age.wane,slim.quant = 0.05, view.plot = T, save.plot=T, filename = "plot-wane-long-test.png")
