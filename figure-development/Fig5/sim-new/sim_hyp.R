...
# H0
out.cam.norm.short = sim.SIR.age.four.clim.maintain(yrs=60,
                                              ntyr=26,
                                              s=101, 
                                              foi=c(rep(.9,20),fit.dat$lambda[fit.dat$provname=="National"]), 
                                              births =  birth.dat$value[2:length(birth.dat$value)], # these are per 1000
...
save(out.cam.norm.short, file = "cam-sim-4-sero-short.Rdata")
...
out.age <- summarise.age.dist(dat = out.cam.norm.short, year.start = 1961)
  
save(out.age, file = "cam-age-sum-4-sero.Rdata")  
#and plot cases
...
plot.age.dist(df=out.age,slim.quant = 0.05, view.plot = T, save.plot=T, filename = "normal_sim.png")
