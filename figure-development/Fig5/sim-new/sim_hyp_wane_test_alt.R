...
out.cam.wane.test.sec = sim.SIR.age.four.clim.wane.sec(yrs=10,
                                              ntyr=26,
                                              s=101, 
                                              foi=fit.dat$lambda[fit.dat$provname=="National"][31:40], 
                                              births =  birth.dat$value[52:61], # these are per 1000
                                              pop_vector =((pop.melt$count[pop.melt$year==1950])/100), 
                                              recov=1,
                                              age.mult.df=age.fit, 
...
save(out.cam.wane.test.sec, file = "cam-sim-4-sero-wane-test-sec.Rdata")

load("cam-sim-4-sero-wane-test-sec.Rdata")
...
out.age.wane <- summarise.age.dist(dat = out.cam.wane.test.sec, year.start = 2011)
...
plot.age.dist(df=out.age.wane,slim.quant = 0.05, view.plot = T, save.plot=T, filename = "plot-wane-long-test-sec.png")
