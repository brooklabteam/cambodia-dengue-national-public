...
rm(list=ls())
 ...
 setwd(paste0(homewd, "/figure-development/Fig5/sim-new/clean-sim"))
#set wdset wd
...
fit.dat$lambda[fit.dat$provname=="National" &fit.dat$year>=1999] <- .07
# mean of that estimated - this makes a constant FOI for comparison
