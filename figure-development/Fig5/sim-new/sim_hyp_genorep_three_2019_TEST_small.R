...
age.fit = subset(age.fit, age_max<=20)
mort.melt = subset(mort.melt, age<=19)
pop.melt = subset(pop.melt, age<=19)

# H0


test.no.intro.small = sim.SIR.age.three.clim.wane.intro(yrs=20,
                                                  ntyr=26,
                                                  s=20, 
                                                  foi=rep(.1, 20), 
                                                  births =  birth.dat$value[22:41], # these are per 1000
...
save(test.no.intro.small, file = "test.no.intro.small.Rdata")


#test intro
test.2007.intro.small = sim.SIR.age.three.clim.wane.intro(yrs=20,
                                                  ntyr=26,
                                                  s=20, 
                                                  foi=rep(.1, 20), 
                                                  births =  birth.dat$value[22:41], # these are per 1000
...
save(test.2007.intro.small, file = "test.2007.intro.small.Rdata")
...
out.age.no.intro.small <- summarise.age.dist(dat = test.no.intro.small, year.start = min(test.no.intro.small$year))
out.age.2007.intro.small <- summarise.age.dist(dat = test.2007.intro.small, year.start = min(test.2007.intro.small$year))
...
plot.age.dist(df=out.age.no.intro.small,slim.quant = 0.05, view.plot = T, save.plot=T, filename = "test_no_intro_small.png")
plot.age.dist(df=out.age.2007.intro.small,slim.quant = 0.05, view.plot = T, save.plot=T, filename = "test_2007_intro_small.png")
