...
out.cam.wane = sim.SIR.age.four.clim.wane(yrs=80,
                                              ntyr=26,
                                              s=101, 
...
save(out.cam.wane, file = "cam-sim-4-sero-wane.Rdata")

load("cam-sim-4-sero-wane.Rdata")
...
out.age.wane <- summarise.age.dist(dat = out.cam.wane, year.start = 1941)
...
plot.age.dist(df=out.age.wane,slim.quant = 0.05, view.plot = T, save.plot=T, filename = "plot-wane-long.png")
