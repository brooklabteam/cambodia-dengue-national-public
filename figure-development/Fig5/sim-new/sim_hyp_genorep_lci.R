...
# H0
out.cam.geno.rep.2007 = sim.SIR.age.four.clim.wane.intro(yrs=40,
                                              ntyr=26,
                                              s=101, 
                                              foi=c(fit.dat$lambda[fit.dat$provname=="National"]), 
                                              births =  birth.dat$value[22:length(birth.dat$value)], # these are per 1000
...
out.age <- summarise.age.dist(dat = out.cam.geno.rep.2007, year.start = 1981)
...
plot.age.dist.five(df=out.age,slim.quant = 0.05, view.plot = T, save.plot=T, filename = "sim_intro_2007.png")
