...
test.no.intro = sim.SIR.age.three.clim.wane.intro(yrs=20,
                                                  ntyr=26,
                                                  s=101, 
                                                  foi=rep(.1, 20), 
...
save(test.no.intro, file = "test.no.intro.Rdata")


#test intro
test.2007.intro = sim.SIR.age.three.clim.wane.intro(yrs=20,
                                                  ntyr=26,
                                                  s=101, 
                                                  foi=rep(.1, 20), 
                                                  births =  birth.dat$value[22:41], # these are per 1000
...
save(test.2007.intro, file = "test.2007.intro.Rdata")
...
out.age.no.intro <- summarise.age.dist(dat = test.no.intro, year.start = min(test.no.intro$year))
out.age.2007.intro <- summarise.age.dist(dat = test.2007.intro, year.start = min(test.2007.intro$year))
...
plot.age.dist(df=out.age.no.intro,slim.quant = 0.05, view.plot = T, save.plot=T, filename = "test_no_intro.png")
plot.age.dist(df=out.age.2007.intro,slim.quant = 0.05, view.plot = T, save.plot=T, filename = "test_2007_intro.png")
